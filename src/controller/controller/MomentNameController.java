...
public class MomentNameController implements controller.controller.Observable{

	private MomentExperience momentExp;
	private LinkedList<Observer> ObsMomentNames;
	
	public MomentNameController(MomentExperience moment) {
