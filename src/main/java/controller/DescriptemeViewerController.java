...
public class DescriptemeViewerController implements Initializable {
	...
	private IPropertyAdapter mProperty;
	...
	public DescriptemeViewerController(Main main, Stage s, IPropertyAdapter p, Observable o) {
		this(main, s, o);
		this.mProperty = p;
	...
	private DescriptemeViewerController(Main main, Stage s, Observable o) {
		this.mDescriptemes = new LinkedList<IDescriptemeAdapter>();
		this.main = main;
		this.stage = s;
		this.mObservable = o;
	}

	private void cloneList(LinkedList<IDescriptemeAdapter> list) {
		for(IDescriptemeAdapter d : list) {
